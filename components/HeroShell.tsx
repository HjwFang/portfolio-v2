    ...
    >
      <div className="flex min-h-screen flex-col lg:flex-row h-full">
        ...
        <div className="flex flex-col lg:w-fit lg:h-screen lg:sticky lg:top-0 justify-between z-20">
          <div className="flex-1 flex flex-col border-x border-foreground/10 bg-foreground/[0.02] px-[clamp(24px,4.635vw,89px)]">
            <header className="shrink-0 pt-[7vh] sm:pt-[10vh]">
              <div className="flex w-fit flex-col items-start">
                <div className="content-stretch flex flex-col sm:flex-row items-start sm:items-end justify-start gap-6 pointer-events-none">
                  ...
                  <div className="flex flex-col items-start relative shrink-0">
                    <h1 className="m-0 font-general font-medium leading-[normal] text-foreground text-[clamp(44px,6vw,116px)] tracking-[-0.08em] sm:tracking-[-0.1em] whitespace-nowrap text-left">
                      horst fang
                    </h1>
                    <div className="ml-[2px] sm:ml-[5px] font-quicksand font-light leading-[normal] text-foreground text-[clamp(14px,1.1vw,21px)] whitespace-nowrap">
                      syde @uwaterloo
                    </div>
                  </div>
                </div>
                ...
                {/* Attraction Area: Positioned between Nav and Footer */}
        ...
        {/* Hero Content Area: Dynamic content based on hover */}
        <main className="flex-1 flex flex-col justify-start pt-[7vh] sm:pt-[10vh] px-[clamp(24px,4.635vw,89px)] pb-10 lg:pb-0 min-h-[50vh] lg:min-h-screen z-10">
          {children}
        </main>
